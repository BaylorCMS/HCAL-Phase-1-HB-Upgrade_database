...
class QieAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ('QIE information', {'fields': ['barcode', 'readout_module', 'readout_module_slot', 'uid', 'bridge_major_ver', 'bridge_minor_ver', 'bridge_other_ver', 'igloo_top_major_ver', 'igloo_bot_major_ver', 'igloo_top_minor_ver','igloo_bot_minor_ver', 'comments']}),
    ]
    ...
    def get_readonly_fields(self, request, obj=None):
        if obj: # editing an existing object
            return self.readonly_fields + ('barcode', 'uid') + ('bridge_major_ver', 'bridge_minor_ver') +  ('bridge_other_ver', 'igloo_top_major_ver') + ('igloo_bot_major_ver', 'igloo_bot_minor_ver') + ('igloo_top_minor_ver', None)
